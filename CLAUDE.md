...
1. **nix-darwin** (`darwinConfigurations."workbook"`) - System-level configuration
   ...
   - Handles system packages (tailscale, mosh, docker, docker-compose, mutagen, mutagen-compose), services, and system settings
...
2. **`/Users/arthurbook/projects/dotfiles/nix/system/darwin.nix`**
   - System-level packages: tailscale, mosh, docker, docker-compose, mutagen, mutagen-compose
