...
vim.diagnostic.config({
	virtual_text = {
		format = function(diagnostic)
			-- Customize the diagnostic message to include the source and the code
			return string.format(
				"%s: %s (%s)",
				diagnostic.source or "LSP", -- Fallback to "LSP" if source isn't provided
				diagnostic.message,
				diagnostic.code or "n/a" -- Fallback to "n/a" if code isn't provided
			)
		end,
	},
	-- ... other diagnostic display configurations
})
